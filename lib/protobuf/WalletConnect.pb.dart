...
class ParseRequestOutput extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'ParseRequestOutput', package: const $pb.PackageName(_omitMessageNames ? '' : 'TW.WalletConnect.Proto'), createEmptyInstance: create)
    ...
    ..aOM<$3.SigningInput>(3, _omitFieldNames ? '' : 'binance', subBuilder: $3.SigningInput.create)
    ..aOM<$4.SigningInput>(4, _omitFieldNames ? '' : 'solana', subBuilder: $4.SigningInput.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(3)
  $3.SigningInput get binance => $_getN(2);
  @$pb.TagNumber(3)
  set binance($3.SigningInput v) { setField(3, v); }
  @$pb.TagNumber(3)
  $core.bool hasBinance() => $_has(2);
  @$pb.TagNumber(3)
  void clearBinance() => clearField(3);
  @$pb.TagNumber(3)
  $3.SigningInput ensureBinance() => $_ensure(2);

  @$pb.TagNumber(4)
  $4.SigningInput get solana => $_getN(3);
  @$pb.TagNumber(4)
  set solana($4.SigningInput v) { setField(4, v); }
  @$pb.TagNumber(4)
  $core.bool hasSolana() => $_has(3);
  @$pb.TagNumber(4)
  void clearSolana() => clearField(4);
  @$pb.TagNumber(4)
  $4.SigningInput ensureSolana() => $_ensure(3);
}
